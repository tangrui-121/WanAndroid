...
public class CommonUtils {
    ...
    public static int dp2px(float dpValue) {
        final float scale = App._mContext.getResources().getDisplayMetrics().density;
    ...
    public static boolean isNetworkConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) App._mContext.getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static int randomTagColor() {
        ...
        int position = randomNum % Consts.TAB_COLORS.length;
        if (position < 0) {
            position = -position;
        }
        return Consts.TAB_COLORS[position];
    }
