...
import com.example.mrtang.wanandroid.adapter.ProjectAdapter;
import com.example.mrtang.wanandroid.fragment.knowledgefragment.knowlist.IKnowlistPresenter;
import com.example.mrtang.wanandroid.fragment.knowledgefragment.knowlist.IKnowlistView;
import com.example.mrtang.wanandroid.fragment.knowledgefragment.knowlist.KnowlistFragmentlmpl;
...
public class ProjectlistFragment<T extends IKnowlistPresenter> extends BaseFragment implements IKnowlistView {
    ...
    public static ProjectlistFragment create(int id) {
    ...
    private void initview() {
        mAdapter = new ProjectAdapter(R.layout.item_project, doclistBeans);
