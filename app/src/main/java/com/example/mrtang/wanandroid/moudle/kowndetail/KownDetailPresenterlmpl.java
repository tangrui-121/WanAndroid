...
public class KownDetailPresenterlmpl implements CallBackListener,IKownDetailPresenter{
    private IKownDetailView iView;
    private Request request;

    public  KownDetailPresenterlmpl(IKownDetailView view){
        this.iView = view;
    }
